...
import Weather from './WeatherSimple';
...
export default function Hero({
  ...
  heroSubtitle   = 'Baška · Island Krk · Croatia',
  heroButtonText = 'Explore apartments',
}: HeroProps) {
