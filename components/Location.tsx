  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      el.style.cssText = [
        ...
        'background:#b97a3a','border:3px solid white','transform:rotate(-45deg)',
        'box-shadow:0 4px 18px rgba(185,122,58,0.5)','cursor:pointer','transition:transform 0.15s ease',
      ].join(';');
        ...
        .setPopup(
          new mapboxgl.Popup({ offset: 28, closeButton: false })
            .setHTML(
              ...
              + '<p style="font-size:13px;font-weight:600;color:#443932;margin:0">Apartments Dekanić</p>'
    ...
    <section id="location" className="py-12 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          {/* Left: text */}
          <div>
            <h2 className="font-serif text-4xl md:text-5xl text-stone-900 font-light mb-5">{t('title')}</h2>
            ...
            <div className="space-y-3 mb-8">
              {([
                ['🏖️', 'Baška Beach', '5 min'],
                ['🛒', 'Supermarket', '3 min'],
                ['⛴️', 'Ferry to Lopar', '20 min'],
                ['✈️', 'Rijeka Airport', '45 min'],
