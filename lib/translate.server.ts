/**
 * Server-only translation helpers.
 * Never import this file from a client component.
 * i18n.ts uses this directly so getRequestConfig can call Google Translate
 * without a self-fetch (relative URLs have no base in Next.js server context).
 */
...
export async function getTranslatedMessages(locale: string): Promise<unknown> {
